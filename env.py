...
class DeepQ():
    ...
    def create_head(self):
        ...
        x = layers.Conv2D(64,3, activation="relu",kernel_regularizer=regularizers.l2(self.L2_reg))(inputs)   
        ...
        x_white = layers.Dense(64, activation="relu",kernel_regularizer=regularizers.l2(self.L2_reg))(x)  
        x_black = layers.Dense(64, activation="relu",kernel_regularizer=regularizers.l2(self.L2_reg))(x)  
